...
public class Airlines {
	...
	public Map<String, Airports> airline_destinations = new HashMap<String, Airports>();
	...
	public Map<String, Airports> getAirline_destinations() {
		return airline_destinations;
	}

	public void setAirline_destinations(Map<String, Airports> airline_destinations) {
		this.airline_destinations = airline_destinations;
	}
